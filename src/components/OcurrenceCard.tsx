...
type NagivigationProps = NativeStackNavigationProp<
  ParamListBase,
  "OcurrenceCard"
>;
...
const OcurrenceCard = ({
  ...
  const handleDelete = () => {
    Alert.alert(
      "Excluir reporte",
      "Tem certeza que deseja excluir esse reporte?",
      [
        {
          text: "Não",
          style: "cancel",
  ...
  return (
    <View style={styles.OcurrenceCard}>
      <View style={styles.Info}>
        <View style={styles.Header}>
          ...
          <TouchableOpacity style={styles.DeleteButton} onPress={handleDelete}>
            <Ionicons name={"trash-sharp"} color={"white"} size={16} />
          </TouchableOpacity>
        </View>
        ...
        <View>
          ...
          <Text style={styles.Text}>
            {ocurrence.description.length > 140
              ? `${ocurrence.description.substring(0, 140).trim()}...`
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate("Ver Ocorrência", { ocurrence })}
      >
        <Text style={styles.Text}>Ver</Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate("Editar Ocorrência", { ocurrence })}
      >
